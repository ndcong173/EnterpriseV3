        ...
        <div className={"w-screen min-h-screen fixed top-0 left-0 z-20 flex" + visibleClass} style={{ backgroundColor: 'rgb(0,0,0,.6)' }}>
            <form className="bg-reddit_dark border border-reddit_dark-brightest p-5 w-3/4 md:w-1/2 lg:w-1/2 mx-auto rounded-2xl text-reddit_text self-center">
                ...
                <label>
                    ...
                    <input
                        type="text"
                        className='mt-1 mb-3 w-full rounded-xl bg-reddit_dark-brighter border p-2 border-reddit_dark-brightest'
                        placeholder="Title"
                        value={title}
                        onChange={e => setTitle(e.target.value)} />
                </label>
                <div>
                    <div className="w-full mb-4 border border-reddit_dark-brightest rounded-lg bg-reddit_dark">
                        <div className="flex items-center justify-between px-3 py-2 border-b dark:border-reddit_dark-brightest">
                        ...
                        <div className="px-4 py-2 rounded-b-lg bg-reddit_dark-brighter">
                            <label for="editor" className="sr-only">Publish post</label>
                            <textarea
                                rows="8"
                                className="block w-full px-0 text-sm border-0 bg-reddit_dark-brighter focus:ring-0 text-reddit_text"
